...
class LoginPage(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        # Jira Server URL
        ttk.Label(self, text="Jira Server URL:", bootstyle="primary").pack(anchor=W, padx=10, pady=(10, 0))
        ...
        # Username
        ttk.Label(self, text="Username:", bootstyle="primary").pack(anchor=W, padx=10, pady=(10, 0))
        ...
        # Token
        ttk.Label(self, text="Token:", bootstyle="primary").pack(anchor=W, padx=10, pady=(10, 0))
        ...
        # Login Button
        login_button = ttk.Button(self, text="Login", bootstyle=SUCCESS, command=self.login)
